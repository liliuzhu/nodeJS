            ...
            <div class="checkout-order">
                ...
                <div class="item-list-wrap confirm-item-list-wrap">
                    <div class="cart-item order-item">
                        ...
                        <ul class="cart-item-list">
                            <li v-for="(item,index) in cartListChecked" :key="index">
                ...
                <div class="order-foot-wrap">
                    <div class="prev-btn-wrap">
                        <button class="btn btn--m" @click="$router.back();">返回上一级</button>
                    </div>
        ...
        computed: {
            ...
            subTotal() {
                ...
                this.cartListChecked.forEach((item) => {
                    money += Number.parseFloat(item.salePrice) * Number.parseInt(item.productNum);
                });
                return money;
            },
            orderTotal() {
