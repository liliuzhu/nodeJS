                                ...
                                <div class="cart-tab-1">
                                    <div class="cart-item-check">
                                        <a href="javascipt:;" class="checkbox-btn item-check-btn"
                                           :class="{'check':item.checked}" @click="editCart('checked',item)">
                                    ...
                                    <div class="cart-item-pic">
                                        <img v-lazy="'/static/'+item.productImage" :title="item.productName"
                        ...
                        <div class="cart-foot-r">
                            <div class="item-total">
                                总计: <span class="total-price"
                                          style="margin-left: 0;">{{totalPrice | currency('¥')}}</span>
                            </div>
                            <div class="btn-wrap">
                                <a class="btn btn--red" v-bind:class="{'btn--dis':totalPrice<=0}" @click="checkOut">
                                    去结账 </a>
                            </div>
                        </div>
                    </div>
        ...
        computed: {
            ...
            totalPrice() {
                ...
                this.cartList.forEach((item) => {
                    if (item.checked) {
                        money += Number.parseInt(item.productNum) * Number.parseFloat(item.salePrice);
                    }
                });
                return money;
            }
